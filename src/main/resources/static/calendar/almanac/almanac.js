...
;(function($) {
    ...
    return this.each(function(){
        ...
        Almanac.drawCld(options.currYear || Almanac.today.tY(), (options.currMonth || options.currMonth == 0 ? options.currMonth : Almanac.today.tM()), global.afterDrawCld);
        if (global.callFunc) global.callFunc();
        if(options.currYear !== undefined && options.currMonth !== undefined){
            global.currYear = options.currYear;
            DateSelection.currYear = options.currYear;
            global.currMonth = options.currMonth;
            DateSelection.currMonth = options.currMonth;
            DateSelection.freshControlBar();
        }
        /*年份递减*/
