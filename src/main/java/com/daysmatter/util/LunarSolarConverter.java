...
// WARNING: Dates before Oct. 1582 are inaccurate
    ...
    public static String lunarMonthToGanZhi(int lunarMonth){
        final String[] tianGan = {"正","二","三","四","五","六","七","八","九","十","十一","十二"};
        return tianGan[lunarMonth-1]+"月";
    }

    public static String lunarDayToGanZhi(int lunarDay){
        final String[] tianGan = {"初一","初二","初三","初四","初五","初六","初七","初八","初九","初十"
                ,"十一","十二","十三","十四","十五","十六","十七","十八","十九","二十","廿一","廿二"
                ,"廿三","廿四","廿五","廿六","廿七","廿八","廿九","三十"};
        return tianGan[lunarDay-1];
    }
    public static String lunarDateToGanZhi(String date){
        ...
        return lunarYearToGanZhi(lunar.lunarYear)+"("+lunar.lunarYear+") " + lunarMonthToGanZhi(lunar.lunarMonth) + lunarDayToGanZhi(lunar.lunarDay);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lunarDateToGanZhi("2022-10-01"));
